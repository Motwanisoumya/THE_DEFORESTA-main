<script>
  ...
  function goToNewPage() {
    goto('../SatelliteImageFinder'); // Change '/your-new-page' to your desired route
  }
</script>
  ...
  <p class = "dark:text-white text-5xl paratext mb-20 w-2/3 text-center"> Upload images of any area over a period of time and this model will analyse the Deforestation percentages over a period of time</p>
    ...
    <button on:click={goToNewPage} class="butto text-3xl bg-green-300 dark:bg-green-500 dark:hover:bg-blue-500 hover:bg-blue-300 rounded-md p-4 madimi dark:text-white mt-10">
  find sat images
</button>
